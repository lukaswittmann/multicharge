...
module multicharge_param_eeqbceps2025
   use mctc_env, only: wp
   use mctc_io_symbols, only: to_number
   implicit none
   private

   public :: get_eeqbceps_chi, get_eeqbceps_eta, get_eeqbceps_rad, get_eeqbceps_kcnchi, &
      & get_eeqbceps_kqchi, get_eeqbceps_kqeta, get_eeqbceps_cap, get_eeqbceps_cov_radii, &
      & get_eeqbceps_avg_cn, get_eeqbceps_born_radii

   !> Element-specific electronegativity for the eeqbceps charges
   interface get_eeqbceps_chi
      module procedure get_eeqbceps_chi_sym
      module procedure get_eeqbceps_chi_num
   end interface get_eeqbceps_chi

   !> Element-specific chemical hardnesses for the eeqbceps charges
   interface get_eeqbceps_eta
      module procedure :: get_eeqbceps_eta_sym
      module procedure :: get_eeqbceps_eta_num
   end interface get_eeqbceps_eta

   !> Element-specific charge widths for the eeqbceps charges
   interface get_eeqbceps_rad
      module procedure :: get_eeqbceps_rad_sym
      module procedure :: get_eeqbceps_rad_num
   end interface get_eeqbceps_rad

   !> Element-specific CN scaling of the electronegativity for the eeqbceps charges
   interface get_eeqbceps_kcnchi
      module procedure :: get_eeqbceps_kcnchi_sym
      module procedure :: get_eeqbceps_kcnchi_num
   end interface get_eeqbceps_kcnchi

   !> Element-specific local q scaling of the electronegativity for the eeqbceps charges
   interface get_eeqbceps_kqchi
      module procedure :: get_eeqbceps_kqchi_sym
      module procedure :: get_eeqbceps_kqchi_num
   end interface get_eeqbceps_kqchi

   !> Element-specific local q scaling of the chemical hardness for the eeqbceps charges
   interface get_eeqbceps_kqeta
      module procedure :: get_eeqbceps_kqeta_sym
      module procedure :: get_eeqbceps_kqeta_num
   end interface get_eeqbceps_kqeta

   !> Element-specific bond capacitance for the eeqbceps charges
   interface get_eeqbceps_cap
      module procedure :: get_eeqbceps_cap_sym
      module procedure :: get_eeqbceps_cap_num
   end interface get_eeqbceps_cap

   !> Element-specific covalent radii for the CN for the eeqbceps charges
   interface get_eeqbceps_cov_radii
      module procedure :: get_eeqbceps_cov_radii_sym
      module procedure :: get_eeqbceps_cov_radii_num
   end interface get_eeqbceps_cov_radii

   !> Element-specific average CN for the eeqbceps charges
   interface get_eeqbceps_avg_cn
      module procedure :: get_eeqbceps_avg_cn_sym
      module procedure :: get_eeqbceps_avg_cn_num
   end interface get_eeqbceps_avg_cn

   !> Element-specific Born radii for the eeqbceps charges
   interface get_eeqbceps_born_radii
      module procedure :: get_eeqbceps_born_radii_sym
      module procedure :: get_eeqbceps_born_radii_num
   end interface get_eeqbceps_born_radii

   !> Maximum atomic number allowed in eeqbceps calculations
   ...
   !> Element-specific averaged coordination number over the fitset for the eeqbceps charges
   real(wp), parameter :: eeqbceps_avg_cn(max_elem) = [&
...
contains
   ...
   elemental function get_eeqbceps_chi_sym(symbol) result(chi)
      ...
      chi = get_eeqbceps_chi(to_number(symbol))

   end function get_eeqbceps_chi_sym

   !> Get electronegativity for species with a given atomic number
   elemental function get_eeqbceps_chi_num(number) result(chi)
      ...
      if (number > 0 .and. number <= size(eeqbceps_chi, dim=1)) then
         chi = eeqbceps_chi(number)
      else
         chi = -1.0_wp
      end if

   end function get_eeqbceps_chi_num

   !> Get hardness for species with a given symbol
   elemental function get_eeqbceps_eta_sym(symbol) result(eta)
      ...
      eta = get_eeqbceps_eta(to_number(symbol))

   end function get_eeqbceps_eta_sym

   !> Get hardness for species with a given atomic number
   elemental function get_eeqbceps_eta_num(number) result(eta)
      ...
      if (number > 0 .and. number <= size(eeqbceps_eta, dim=1)) then
         eta = eeqbceps_eta(number)
      else
         eta = -1.0_wp
      end if

   end function get_eeqbceps_eta_num

   !> Get charge width for species with a given symbol
   elemental function get_eeqbceps_rad_sym(symbol) result(rad)
      ...
      rad = get_eeqbceps_rad(to_number(symbol))

   end function get_eeqbceps_rad_sym

   !> Get charge width for species with a given atomic number
   elemental function get_eeqbceps_rad_num(number) result(rad)
      ...
      if (number > 0 .and. number <= size(eeqbceps_rad, dim=1)) then
         rad = eeqbceps_rad(number)
      else
         rad = -1.0_wp
      end if

   end function get_eeqbceps_rad_num

   !> Get CN scaling of the electronegativity for species with a given symbol
   elemental function get_eeqbceps_kcnchi_sym(symbol) result(kcnchi)
      ...
      kcnchi = get_eeqbceps_kcnchi(to_number(symbol))

   end function get_eeqbceps_kcnchi_sym

   !> Get CN scaling of the electronegativity for species with a given atomic number
   elemental function get_eeqbceps_kcnchi_num(number) result(kcnchi)
      ...
      if (number > 0 .and. number <= size(eeqbceps_kcnchi, dim=1)) then
         kcnchi = eeqbceps_kcnchi(number)
      else
         kcnchi = -1.0_wp
      end if

   end function get_eeqbceps_kcnchi_num

   !> Get local q scaling of the electronegativity for species with a given symbol
   elemental function get_eeqbceps_kqchi_sym(symbol) result(kqchi)
      ...
      kqchi = get_eeqbceps_kqchi(to_number(symbol))

   end function get_eeqbceps_kqchi_sym

   !> Get local q scaling of the electronegativity for species with a given atomic number
   elemental function get_eeqbceps_kqchi_num(number) result(kqchi)
      ...
      if (number > 0 .and. number <= size(eeqbceps_kqchi, dim=1)) then
         kqchi = eeqbceps_kqchi(number)
      else
         kqchi = -1.0_wp
      end if

   end function get_eeqbceps_kqchi_num

   !> Get local q scaling of the chemical hardness for species with a given symbol
   elemental function get_eeqbceps_kqeta_sym(symbol) result(kqeta)
      ...
      kqeta = get_eeqbceps_kqeta(to_number(symbol))

   end function get_eeqbceps_kqeta_sym

   !> Get local q scaling of the chemical hardness for species with a given atomic number
   elemental function get_eeqbceps_kqeta_num(number) result(kqeta)
      ...
      if (number > 0 .and. number <= size(eeqbceps_kqeta, dim=1)) then
         kqeta = eeqbceps_kqeta(number)
      else
         kqeta = -1.0_wp
      end if

   end function get_eeqbceps_kqeta_num

   !> Get bond capacitance for species with a given symbol
   elemental function get_eeqbceps_cap_sym(symbol) result(cap)
      ...
      cap = get_eeqbceps_cap(to_number(symbol))

   end function get_eeqbceps_cap_sym

   !> Get bond capacitance for species with a given atomic number
   elemental function get_eeqbceps_cap_num(number) result(cap)
      ...
      if (number > 0 .and. number <= size(eeqbceps_cap, dim=1)) then
         cap = eeqbceps_cap(number)
      else
         cap = -1.0_wp
      end if

   end function get_eeqbceps_cap_num

   !> Get covalent radius for species with a given symbol
   elemental function get_eeqbceps_cov_radii_sym(symbol) result(rcov)
      ...
      rcov = get_eeqbceps_cov_radii(to_number(symbol))

   end function get_eeqbceps_cov_radii_sym

   !> Get covalent radius for species with a given atomic number
   elemental function get_eeqbceps_cov_radii_num(number) result(rcov)
      ...
      if (number > 0 .and. number <= size(eeqbceps_cov_radii, dim=1)) then
         rcov = eeqbceps_cov_radii(number)
      else
         rcov = -1.0_wp
      end if

   end function get_eeqbceps_cov_radii_num

   !> Get average CN for species with a given symbol
   elemental function get_eeqbceps_avg_cn_sym(symbol) result(avg_cn)
      ...
      avg_cn = get_eeqbceps_avg_cn(to_number(symbol))

   end function get_eeqbceps_avg_cn_sym

   !> Get average CN for species with a given atomic number
   elemental function get_eeqbceps_avg_cn_num(number) result(avg_cn)
      ...
      if (number > 0 .and. number <= size(eeqbceps_avg_cn, dim=1)) then
         avg_cn = eeqbceps_avg_cn(number)
      else
         avg_cn = -1.0_wp
      end if

   end function get_eeqbceps_avg_cn_num

   !> Get born radii for species with a given symbol
   elemental function get_eeqbceps_born_radii_sym(symbol) result(born_rad)
      ...
      born_rad = get_eeqbceps_born_radii(to_number(symbol))

   end function get_eeqbceps_born_radii_sym

   !> Get born radii for species with a given atomic number
   elemental function get_eeqbceps_born_radii_num(number) result(born_rad)
      !> Atomic number
      integer, intent(in) :: number
      ...
      if (number > 0 .and. number <= size(eeqbceps_born_radii, dim=1)) then
         born_rad = eeqbceps_born_radii(number)
      else
         born_rad = -1.0_wp
      end if

   end function get_eeqbceps_born_radii_num

end module multicharge_param_eeqbceps2025
